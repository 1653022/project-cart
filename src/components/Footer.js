                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-lg-2 ml-auto">
                            ...
                            <div className="social-section text-md-left">
                                <ul className="text-center">
                                    <li>
                                        <a className="btn-floating  btn-fb waves-effect waves-light" href='#1'>
                                            <i className="fa fa-facebook"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="btn-floating  btn-ins waves-effect waves-light" href='#1'>
                                            <i className="fa fa-instagram"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="btn-floating  btn-tw waves-effect waves-light" href='#1'>
                                            <i className="fa fa-twitter"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="btn-floating  btn-yt waves-effect waves-light"href='#1'>
                                            <i className="fa fa-youtube"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="btn-floating  btn-li waves-effect waves-light"href='#1'>
                                            <i className="fa fa-linkedin"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="btn-floating  btn-dribbble waves-effect waves-light"href='#1'>
                                            <i className="fa fa-dribbble left"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="btn-floating  btn-pin waves-effect waves-light"href='#1'>
                                            <i className="fa fa-pinterest"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="btn-floating  btn-gplus waves-effect waves-light"href='#1'>
                        ...
                        <div className="col-lg-2">
                            ...
                            <ul>
                                <li>
                                    <a href='#1'>Store Delivery</a>
                                </li>
                                <li>
                                    <a href='#1'>Online Delivery</a>
                                </li>
                                <li>
                                    <a href='#1'>Delivery Terms &amp; Conditions</a>
                                </li>
                                <li>
                                    <a href='#1'>Tracking</a>
                                </li>
                        ...
                        <div className="col-lg-2">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href='#1'>Return Policy</a>
                                </li>
                                <li>
                                    <a href='#1'>Product Registration</a>
                                </li>
                            </ul>
