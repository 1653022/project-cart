            ...
            <header>
                <ul id="slide-out" className="side-nav hidden custom-scrollbar sn-bg-2 ps ps--theme_default" data-ps-id="c27390a3-9efc-e0d8-197a-ab96d73a156a">
                    ...
                    <li>
                        <ul className="social">
                            <li>
                                <a className="icons-sm fb-ic" href='#1'>
                                    <i className="fa fa-facebook"> </i>
                                </a>
                            </li>
                            <li>
                                <a className="icons-sm pin-ic" href='#1'>
                                    <i className="fa fa-pinterest"> </i>
                                </a>
                            </li>
                            <li>
                                <a className="icons-sm gplus-ic" href='#1'>
                                    <i className="fa fa-google-plus"> </i>
                                </a>
                            </li>
                            <li>
                                <a className="icons-sm tw-ic" href='#1'>
                    ...
                    <li>
                        ...
                        <ul className="collapsible collapsible-accordion">
                            <li>
                                <a className="collapsible-header waves-effect arrow-r" href='#1'>
                            ...
                            <li className="active">
                                <a className="collapsible-header waves-effect arrow-r active" href='#1'>
                ...
                <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark scrolling-navbar double-nav">
                    ...
                    <div className="float-left">
                        <a data-activates="slide-out" className="button-collapse" href='#1'>
                    ...
                    <ul className="nav navbar-nav nav-flex-icons ml-auto">
                        <li className="nav-item dropdown">
                            ...
                            <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
                                <a className="dropdown-item waves-effect waves-light" href='#1'>Đăng Ký</a>
                                <a className="dropdown-item waves-effect waves-light" href='#1'>Đăng Nhập</a>
                                <a className="dropdown-item waves-effect waves-light" href='#1'>Đăng Xuất</a>
                            </div>
                        </li>
                    </ul>
